...
function createPL(v3d = window.v3d) {
  ...
  const createPzLib = ({ v3d = null, appInstance = null }) => {
    ...
    function getMaterialEditableTextures(matName, collectSameNameMats = false) {
      ...
      const textures = mats.reduce((texArray, mat) => {
        ...
        switch (mat.type) {
          ...
          default:
            console.error(
              "getMaterialEditableTextures: Unknown material type " + mat.type
            );
            break;
        }
    ...
    function replaceMaterialEditableTexture(mat, oldTex, newTex) {
      ...
      switch (mat.type) {
        ...
        default:
          console.error(
            "replaceMaterialEditableTexture: Unsupported material type " +
              mat.type
          );
          break;
      }
  ...
  PL.execInitPuzzles = function (options) {
    ...
    function initFullscreen(id, isParent, cb_enter, cb_exit, cb_unavail) {
      ...
      function requestFullscreen(fselem) {
        if (fselem.requestFullscreen) fselem.requestFullscreen();
        else if (fselem.mozRequestFullScreen) fselem.mozRequestFullScreen();
        else if (fselem.webkitRequestFullscreen)
          fselem.webkitRequestFullscreen();
        else if (fselem.msRequestFullscreen) fselem.msRequestFullscreen();
      }
    ...
    function setCSSRuleStyle(prop, value, id, isParent, mediaRule) {
      const styles = isParent
        ? parent.document.styleSheets
      ...
      for (let i = 0; i < styles.length; i++) {
        ...
        for (let j = 0; j < cssRules.length; j++) {
          ...
          if (!mediaRule && cssRule.selectorText == id)
            ...
            mediaRule &&
            cssRule.media &&
            cssRule.media.mediaText == mediaRule
          ) {
  ...
  PL.init = function (appInstance, initOptions) {
    ...
    this.procedures["create_canvas_drawer"] = create_canvas_drawer;
    this.procedures["import_layout_from_file"] = import_layout_from_file;
    this.procedures["restore_saved_canvas_layers"] =
      restore_saved_canvas_layers;
    this.procedures["export_layout_to_file"] = export_layout_to_file;
    this.procedures["upload_layout_to_server"] = upload_layout_to_server;
    this.procedures["restore_other_parameters"] = restore_other_parameters;
    this.procedures["restore_garment_effect_sliders"] =
    ...
    var PROC = {
      create_canvas_drawer: create_canvas_drawer,
      import_layout_from_file: import_layout_from_file,
      restore_saved_canvas_layers: restore_saved_canvas_layers,
      export_layout_to_file: export_layout_to_file,
      upload_layout_to_server: upload_layout_to_server,
      restore_other_parameters: restore_other_parameters,
      restore_garment_effect_sliders: restore_garment_effect_sliders,
    ...
    function featureAvailable(feature) {
      ...
      switch (feature) {
        case "MOBILE":
          return (
            /Android|webOS|BlackBerry/i.test(userAgent) ||
        ...
        case "MACOS":
          return (
            ["Macintosh", "MacIntel", "MacPPC", "Mac68K"].indexOf(platform) !==
              -1 && !v3d.Detector.checkIOS()
          );
        case "CHROMEOS":
        ...
        case "WOOCOMMERCE":
          var woo_fun =
            window.parent.v3d_woo_get_product_info ||
            window.parent.parent.v3d_woo_get_product_info;
          return !!woo_fun;
        case "DO_NOT_TRACK":
    ...
    function cf_drawInit() {
      return function (
        ...
        if (selector != "") {
          ...
          if (window["Konva"] === undefined) {
            !(function (t, e) {
                ...
                (a.prototype.decompose = function () {
                  ...
                  return (
                    0 != i || 0 != n
                      ? ((t = Math.sqrt(i * i + n * n)),
                        (s.rotation =
                          0 < n ? Math.acos(i / t) : -Math.acos(i / t)),
                        (s.scaleX = t),
                        (s.scaleY = a / t),
                        (s.skewX = (i * r + n * o) / a),
                        (s.skewY = 0))
                      : (0 == r && 0 == o) ||
                        ...
                        (s.rotation =
                          Math.PI / 2 -
                          (0 < o ? Math.acos(-r / e) : -Math.acos(r / e))),
                        (s.scaleX = a / e),
                        (s.scaleY = e),
                        (s.skewX = 0),
                        (s.skewY = (i * r + n * o) / a)),
              ...
              var h = Math.PI / 180,
                ...
                A = {
                  ...
                  colorToRGBA: function (t) {
                    return (
                      (t = t || "black"),
                      A._namedColorToRBA(t) ||
                        A._hex3ColorToRGBA(t) ||
                        A._hex6ColorToRGBA(t) ||
                        A._rgbColorToRGBA(t) ||
                        A._rgbaColorToRGBA(t) ||
                        A._hslColorToRGBA(t)
                    );
                  },
                  ...
                  _prepareArrayForTween: function (t, e, i) {
                    var n,
                      ...
                      a = [];
                    for (
                      t.length > e.length && ((r = e), (e = t), (t = r)), n = 0;
                      n < t.length;
                      n += 2
                    )
                      o.push({ x: t[n], y: t[n + 1] });
                    for (n = 0; n < e.length; n += 2)
                      a.push({ x: e[n], y: e[n + 1] });
                    var s = [];
                    return (
                ...
                w = {
                  ...
                  addComponentsGetterSetter: function (t, n, e, r, o) {
                    ...
                    (t.prototype[c] = function (t) {
                      ...
                      return (
                        this._fireChangeEvent(n, i, t), o && o.call(this), this
                      );
                    }),
              ...
              var T = [
                ...
                M =
                  ((R.prototype.fillShape = function (t) {
                  ...
                  (R.prototype.createRadialGradient = function (
                    t,
                    e,
                    i,
                    n,
                  ...
                  (R.prototype.drawImage = function (
                    ...
                    3 === l.length
                      ? c.drawImage(t, e, i)
                      : 5 === l.length
                      ? c.drawImage(t, e, i, n, r)
                      : 9 === l.length &&
                        c.drawImage(t, e, i, n, r, o, a, s, h);
                  }),
                    ...
                    for (
                      var n,
                        ...
                        e = function (t) {
                          ...
                          r[t] = function () {
                            return (
                              (n = o(Array.prototype.slice.call(arguments, 0))),
                              (e = i.apply(r, arguments)),
                              r._trace({ method: t, args: n }),
                              e
                            );
                          };
                        },
              ...
              function R(t) {
                (this.canvas = t),
                  ...
                  G.enableTrace && ((this.traceArr = []), this._enableTrace());
              }
              [
                "fillStyle",
                "strokeStyle",
              ...
              var E,
                I =
                  ...
                  (L.prototype._fill = function (t) {
                    ...
                    r && "color" === o
                      ? this._fillColor(t)
                      : (e = t.getFillPatternImage()) && "pattern" === o
                      ? this._fillPattern(t)
                      : (i = t.getFillLinearGradientColorStops()) &&
                        "linear-gradient" === o
                      ? this._fillLinearGradient(t)
                      : (n = t.getFillRadialGradientColorStops()) &&
                        "radial-gradient" === o
                  ...
                  (L.prototype._applyShadow = function (t) {
                    var e = A,
                      ...
                      r = e.get(t.getShadowOffset(), { x: 0, y: 0 }),
              ...
              function Y(t) {
                ...
                return (e.context = new I(e)), e.setSize(t.width, t.height), e;
              }
              var X,
                j = (P(U, (X = N)), U);
              function U(t) {
                ...
                _drag: function (a) {
                  ...
                  q._dragElements.forEach(function (e, t) {
                    ...
                    n.setPointersPositions(a),
                      void 0 === e.pointerId &&
                        (e.pointerId = A._getFirstPointerId(a));
                    ...
                    if (r) {
                      if ("dragging" !== e.dragStatus) {
                        ...
                        if (
                          Math.max(
                            Math.abs(r.x - e.startPointerPos.x),
                            Math.abs(r.y - e.startPointerPos.y)
                          ) < o
                        )
                          return;
                        if ((i.startDrag({ evt: a }), !i.isDragging())) return;
                      }
                      i._setDragPosition(a, e), s.push(i);
                    }
                  }),
                    s.forEach(function (t) {
                      t.fire(
                        "dragmove",
                        { type: "dragmove", target: t, evt: a },
                        !0
                      );
                    });
                },
                  ...
                  q._dragElements.forEach(function (e, t) {
                    ...
                    r && n.setPointersPositions(r),
                      n._changedPointerPositions.find(function (t) {
                        ...
                        (i =
                          e.node.getLayer() ||
                          (e.node instanceof G.Stage && e.node)) && i.draw());
                  });
                },
                _endDragAfter: function (i) {
                  q._dragElements.forEach(function (t, e) {
                    "stopped" === t.dragStatus &&
                      t.node.fire(
                        "dragend",
                        { type: "dragend", target: t.node, evt: i },
                        !0
                      ),
              ...
              G.isBrowser &&
                (window.addEventListener("mouseup", q._endDragBefore, !0),
              ...
              var Q = {},
                ...
                lt = 1,
                ct =
                  ((dt.prototype.hasChildren = function () {
                    return !1;
                  }),
                  ...
                  (dt.prototype._calculate = function (t, e, i) {
                    var n,
                      r = this;
                    return (
                      this._attachedDepsListeners.get(t) ||
                        ((n = e
                          .map(function (t) {
                  ...
                  (dt.prototype.cache = function (t) {
                    ...
                    if (n && r) {
                      ...
                      var c = new H({
                        ...
                        d = new H({ pixelRatio: o, width: 0, height: 0 }),
                        p = new j({ pixelRatio: 1, width: n, height: r }),
                        u = c.getContext(),
                        f = p.getContext();
                      return (
                        (p.isCache = !0),
                  ...
                  (dt.prototype._transformedRect = function (t, e) {
                    ...
                    return (
                      a.forEach(function (t) {
                        var e = s.point(t);
                        void 0 === i && ((i = r = e.x), (n = o = e.y)),
                          (i = Math.min(i, e.x)),
                          (n = Math.min(n, e.y)),
                          (r = Math.max(r, e.x)),
                          (o = Math.max(o, e.y));
                      }),
                      { x: i, y: n, width: r - i, height: o - n }
                    );
                  }),
                  ...
                  (dt.prototype.on = function (t, e) {
                    ...
                    for (
                      var i, n, r, o = t.split(" "), a = o.length, s = 0;
                      s < a;
                      s++
                    )
                      (n = (i = o[s].split("."))[0]),
                        ...
                        this.eventListeners[n].push({ name: r, handler: e });
                    return this;
                  }),
                  (dt.prototype.off = function (t, e) {
                    ...
                    for (i = 0; i < h; i++)
                      if (((o = (r = s[i].split("."))[0]), (a = r[1]), o))
                        this.eventListeners[o] && this._off(o, a, e);
                      else for (n in this.eventListeners) this._off(n, a, e);
                    return this;
                  }),
                  ...
                  (dt.prototype._delegate = function (t, n, r) {
                    ...
                    this.on(t, function (t) {
                      for (
                        var e = t.target.findAncestors(n, !0, o), i = 0;
                        i < e.length;
                        i++
                      )
                  ...
                  (dt.prototype.getAbsoluteZIndex = function () {
                    ...
                    return (
                      "Stage" !== s.nodeType &&
                        (function t(e) {
                          for (i = [], n = e.length, r = 0; r < n; r++)
                            (o = e[r]),
                              h++,
                              "Shape" !== o.nodeType &&
                                (i = i.concat(o.getChildren().toArray())),
                              o._id === s._id && (r = n);
                  ...
                  (dt.prototype._getAbsoluteOpacity = function () {
                    var t = this.opacity(),
                      e = this.getParent();
                    return (
                      e && !e._isUnderCache && (t *= e.getAbsoluteOpacity()), t
                    );
                  }),
                  (dt.prototype.moveTo = function (t) {
                    return (
                      this.getParent() !== t && (this._remove(), t.add(this)),
                      this
                    );
                  }),
                    ...
                    for (t in ((n.attrs = {}), r))
                      (e = r[t]),
                        (A.isObject(e) &&
                          ...
                          delete r[t],
                          (i ? i.call(this) : null) !== (r[t] = e) &&
                            (n.attrs[t] = e));
                    return (
                      (n.className = this.getClassName()),
                  ...
                  (dt.prototype._isMatch = function (t) {
                    ...
                    for (
                      ...
                      if (
                        ...
                        if (this.id() === e.slice(1)) return !0;
                      } else if ("." === e.charAt(0)) {
                        if (this.hasName(e.slice(1))) return !0;
                  ...
                  (dt.prototype.getAbsoluteTransform = function (t) {
                    return t
                      ...
                      : this._getCache($, this._getAbsoluteTransform);
                  }),
                  (dt.prototype._getAbsoluteTransform = function (t) {
                    ...
                    (i = this._cache.get($) || new p()),
                      this.parent
                        ? this.parent.getAbsoluteTransform().copyInto(i)
                        : i.reset();
                    var e,
                      n,
                      r,
                      o,
                      a = this.transformsEnabled();
                    return (
                      "all" === a
                  ...
                  (dt.prototype._getTransform = function () {
                    var t,
                      e,
                      i = this._cache.get(ot) || new p();
                    i.reset();
                    var n = this.x(),
                      r = this.y(),
                      o = G.getAngle(this.rotation()),
                      a =
                        null !== (t = this.attrs.scaleX) && void 0 !== t
                          ? t
                          : 1,
                      s =
                        null !== (e = this.attrs.scaleY) && void 0 !== e
                          ? e
                          : 1,
                  ...
                  (dt.prototype.clone = function (t) {
                    var e,
                      ...
                      r,
                      o,
                      a = A.cloneObject(this.attrs);
                    for (e in t) a[e] = t[e];
                    var s = new this.constructor(a);
                    for (e in this.eventListeners)
                      for (
                        n = (i = this.eventListeners[e]).length, r = 0;
                        r < n;
                        r++
                      )
                        (o = i[r]).name.indexOf("konva") < 0 &&
                  ...
                  (dt.prototype._off = function (t, e, i) {
                    for (
                      var n, r, o = this.eventListeners[t], a = 0;
                      a < o.length;
                      a++
                    )
                      if (
                  ...
                  (dt.prototype.setName = function (t) {
                    for (
                      ...
                      (e = r[a]), -1 === o.indexOf(e) && e && V(e, this._id);
                    for (a = 0; a < o.length; a++)
                      (e = o[a]),
                        -1 === r.indexOf(e) &&
                          e &&
                          ((i = this),
                          (n = e) && (J[n] || (J[n] = []), J[n].push(i)));
                  ...
                  (dt.prototype.setAttr = function (t, e) {
                    ...
                    return (
                      A._isFunction(i) ? i.call(this, e) : this._setAttr(t, e),
                      this
                    );
                  }),
                  ...
                  (dt.prototype._fireAndBubble = function (t, e, i) {
                    ...
                    e && "Shape" === this.nodeType && (e.target = this),
                      ((t === nt || t === rt) &&
                        ((i &&
                          (this === i ||
                            (this.isAncestorOf && this.isAncestorOf(i)))) ||
                  ...
                  (dt.prototype._fire = function (t, e) {
                    ...
                    if (n)
                      for (
                        (e = e || {}).currentTarget = this, e.type = t, i = 0;
                        i < n.length;
                        i++
                      )
                  ...
                  (dt.prototype._createDragElement = function (t) {
                    var e = t ? t.pointerId : void 0,
                      ...
                      r =
                        i._getPointerById(e) ||
                        i._changedPointerPositions[0] ||
                        n;
                    q._dragElements.set(this._id, {
                      node: this,
                      startPointerPos: r,
                      offset: { x: r.x - n.x, y: r.y - n.y },
                      dragStatus: "ready",
                      pointerId: e,
                    });
                  }),
                  ...
                  (dt.prototype._setDragPosition = function (t, e) {
                    var i,
                      n,
                      r,
                      o = this.getStage()._getPointerById(e.pointerId);
                    o &&
                      ((i = { x: o.x - e.offset.x, y: o.y - e.offset.y }),
                      void 0 !== (n = this.dragBoundFunc()) &&
                        ((r = n.call(this, i, t))
                          ? (i = r)
                          : A.warn(
                    ...
                    this._dragCleanup(),
                      this.on("mousedown.konva touchstart.konva", function (t) {
                        var e,
                          i = this;
                        (void 0 !== t.evt.button &&
                          !(0 <= G.dragButtons.indexOf(t.evt.button))) ||
                          this.isDragging() ||
                          ((e = !1),
                          q._dragElements.forEach(function (t) {
                  ...
                  (dt.prototype._dragChange = function () {
                    if (this.attrs.draggable) this._listenDrag();
                      ...
                      e
                        ? this.stopDrag()
                        : i && q._dragElements.delete(this._id);
                    }
                  }),
                  ...
                  (dt._createNode = function (t, e) {
                    var i,
                      n,
                      r = dt.prototype.getClassName.call(t),
                      o = t.children;
              ...
              function dt(t) {
                ...
                (this._id = lt++),
                  ...
                  this.setAttrs(t),
                  this.on(st, function () {
                    e._batchingTransformChange
                      ? (e._needClearTransformCache = !0)
                      : (e._clearCache(ot), e._clearSelfAndDescendantCache($));
                  }),
                ...
                ft =
                  ...
                  (gt.prototype._drawChildren = function (e, i, n) {
                    ...
                    var u =
                      ...
                      "drawScene" === e;
                    u && (s.save(), s._applyGlobalCompositeOperation(this)),
                      this.children.each(function (t) {
                        t[e](i, n);
                      }),
                      u && s.restore(),
              ...
              w.addComponentsGetterSetter(ft, "clip", [
                "x",
                "y",
                "width",
                "height",
                ...
                St(t),
                  e.getStage() &&
                    ...
                    yt &&
                      e._fire(
                        "gotpointercapture",
                        _t(new PointerEvent("gotpointercapture"))
                      ));
              }
              function St(t) {
                var e,
                  i = vt.get(t);
                i &&
                  ((e = i.getStage()) && e.content,
                  vt.delete(t),
                  yt &&
                    i._fire(
                      "lostpointercapture",
                      _t(new PointerEvent("lostpointercapture"))
                    ));
              }
              var wt = "mouseout",
                Ct = "mouseleave",
              ...
              var jt,
                Ut =
                  ...
                  (qt.prototype.clone = function (t) {
                    return (
                      ((t = t || {}).container = document.createElement("div")),
                  ...
                  (qt.prototype.destroy = function () {
                    ...
                    return -1 < e && Yt.splice(e, 1), this;
                  }),
                  (qt.prototype.getPointerPosition = function () {
                    var t =
                      this._pointerPositions[0] ||
                      this._changedPointerPositions[0];
                    return t
                      ? { x: t.x, y: t.y }
                      : (A.warn(
                  ...
                  (qt.prototype._toKonvaCanvas = function (i) {
                    var n = (i = i || {}).x || 0,
                      ...
                      e = this.children;
                    return (
                      (n || r) && o.translate(-1 * n, -1 * r),
                      e.each(function (t) {
                        var e;
                        t.isVisible() &&
                          ((e = t._toKonvaCanvas(i)),
                          o.drawImage(
                            e._canvas,
                            n,
                            r,
                            e.getWidth() / e.getPixelRatio(),
                            e.getHeight() / e.getPixelRatio()
                          ));
                      }),
                      t
                    );
                  ...
                  (qt.prototype.getIntersection = function (t, e) {
                    if (!t) return null;
                    for (
                      var i, n = this.children, r = n.length - 1;
                      0 <= r;
                      r--
                    )
                      if ((i = n[r].getIntersection(t, e))) return i;
                    return null;
                  }),
                  (qt.prototype._resizeDOM = function () {
                    ...
                    this.content &&
                      ...
                      this.children.each(function (t) {
                        t.setSize({ width: e, height: i }), t.draw();
                      });
                  }),
                  ...
                  (qt.prototype._bindContentEvents = function () {
                    if (G.isBrowser)
                      for (var t = 0; t < Wt; t++) Ht(this, zt[t]);
                  }),
                  ...
                  (qt.prototype._mouseout = function (t) {
                    ...
                    i && n
                      ? (i._fireAndBubble(wt, { evt: t }),
                        i._fireAndBubble(Ct, { evt: t }),
                        this._fire(Ct, {
                          evt: t,
                          target: this,
                          currentTarget: this,
                  ...
                  (qt.prototype._mousemove = function (t) {
                    var e;
                    if (G.UA.ieMobile) return this._touchmove(t);
                    this.setPointersPositions(t);
                    var i,
                      n = A._getFirstPointerId(t),
                      r =
                        null !== (e = this.targetShape) &&
                        void 0 !== e &&
                        e.getStage()
                          ? this.targetShape
                          : null,
                      o = !q.isDragging || G.hitOnDragEnabled;
                    o &&
                      ...
                      i.isListening()
                        ? o && r !== i
                          ? (r &&
                            ...
                            i._fireAndBubble(Pt, { evt: t, pointerId: n }, r),
                            i._fireAndBubble(kt, { evt: t, pointerId: n }, r),
                            i._fireAndBubble(Tt, { evt: t, pointerId: n }),
                            (this.targetShape = i))
                          : i._fireAndBubble(Tt, { evt: t, pointerId: n })
                        : (r &&
                            o &&
                  ...
                  (qt.prototype._mousedown = function (t) {
                    if (G.UA.ieMobile) return this._touchstart(t);
                    this.setPointersPositions(t);
                    ...
                    (q.justDragged = !1),
                      (G.listenClickTap = !0),
                      i && i.isListening()
                        ? (this.clickStartShape = i)._fireAndBubble(At, {
                            evt: t,
                            pointerId: e,
                          })
                        : this._fire(At, {
                  ...
                  (qt.prototype._mouseup = function (t) {
                    if (G.UA.ieMobile) return this._touchend(t);
                    this.setPointersPositions(t);
                    var e = A._getFirstPointerId(t),
                      i = this.getIntersection(this.getPointerPosition()),
                    ...
                    G.inDblClickWindow
                      ...
                      : q.justDragged ||
                        ((G.inDblClickWindow = !0),
                        clearTimeout(this.dblTimeout)),
                      (this.dblTimeout = setTimeout(function () {
                        G.inDblClickWindow = !1;
                      }, G.dblClickWindow)),
                      i && i.isListening()
                        ? ((this.clickEndShape = i)._fireAndBubble(Mt, {
                            evt: t,
                            pointerId: e,
                          }),
                          G.listenClickTap &&
                            ...
                            o &&
                              r &&
                              r === i &&
                              i._fireAndBubble(Lt, { evt: t, pointerId: e })))
                  ...
                  (qt.prototype._touchstart = function (i) {
                    ...
                    this._changedPointerPositions.forEach(function (t) {
                      ...
                      (G.listenClickTap = !0),
                        ...
                        e &&
                          e.isListening() &&
                          (G.captureTouchEventsEnabled &&
                            e.setPointerCapture(t.id),
                          (n.tapStartShape = e)._fireAndBubble(
                            Dt,
                            { evt: i, pointerId: t.id },
                            n
                          ),
                          (r = !0),
                          e.isListening() &&
                      ...
                      this._fire("contentTouchstart", { evt: i });
                  }),
                  (qt.prototype._touchmove = function (i) {
                    var n,
                      ...
                      o = this;
                    this.setPointersPositions(i),
                      (q.isDragging && !G.hitOnDragEnabled) ||
                        ((n = !1),
                        (r = {}),
                        this._changedPointerPositions.forEach(function (t) {
                          ...
                          e &&
                            ...
                            (r[e._id] ||
                              ((r[e._id] = !0),
                              e._fireAndBubble(Ft, { evt: i, pointerId: t.id }),
                              (n = !0),
                              e.isListening() &&
                                e.preventDefault() &&
                                i.cancelable &&
                        ...
                        this._fire("contentTouchmove", { evt: i })),
                      q.isDragging &&
                        q.node.preventDefault() &&
                        i.cancelable &&
                        i.preventDefault();
                  }),
                  (qt.prototype._touchend = function (i) {
                    ...
                    this._changedPointerPositions.forEach(function (t) {
                      ...
                      this._fire("contentTouchend", { evt: i }),
                      G.listenClickTap &&
                        (this._fire("contentTap", { evt: i }),
                        o && this._fire("contentDbltap", { evt: i })),
                      this.preventDefault() &&
                        i.cancelable &&
                        i.preventDefault(),
                      (G.listenClickTap = !1);
                  ...
                  (qt.prototype._pointerdown = function (t) {
                    var e;
                    G._pointerEventsEnabled &&
                      (this.setPointersPositions(t),
                      (e =
                        mt(t.pointerId) ||
                        this.getIntersection(this.getPointerPosition())) &&
                        e._fireAndBubble(Rt, _t(t)));
                  }),
                  ...
                  (qt.prototype.setPointersPositions = function (t) {
                    ...
                    void 0 !== (t = t || window.event).touches
                      ...
                      : ((n = (t.clientX - i.left) / i.scaleX),
                        ...
                        (this._pointerPositions = [
                          { x: n, y: r, id: A._getFirstPointerId(t) },
                        ]),
                        (this._changedPointerPositions = [
                          { x: n, y: r, id: A._getFirstPointerId(t) },
                        ]));
              ...
              var se,
                he =
                  ...
                  (le.prototype.drawHitFromCache = function (t) {
                    ...
                    try {
                      for (
                        n = (i = (e = l.getImageData(0, 0, c, d)).data).length,
              ...
              function le(t) {
                for (
                  var e, i = se.call(this, t) || this;
                  !(e = A.getRandomColor()) || e in ee;
              ...
              (he.prototype._fillFunc = function (t) {
                ...
                w.addComponentsGetterSetter(he, "fillPatternOffset", [
                  "x",
                  "y",
                ]),
                ...
                w.addComponentsGetterSetter(he, "fillLinearGradientEndPoint", [
                  "x",
                  "y",
                ]),
                w.addComponentsGetterSetter(
                ...
                w.addComponentsGetterSetter(he, "fillRadialGradientEndPoint", [
                  "x",
                  "y",
                ]),
              ...
              var ce,
                ...
                ue =
                  ...
                  (fe.prototype.moveUp = function () {
                    if (!ct.prototype.moveUp.call(this)) return !1;
                    var t = this.getStage();
                    return (
                      !!t &&
                      (t.content.removeChild(this.getCanvas()._canvas),
                  ...
                  (fe.prototype._getIntersection = function (t) {
                    var e,
                      ...
                      o = r[3];
                    return 255 === o
                      ? ((e = A._rgbToHex(r[0], r[1], r[2])),
                        (i = ee["#" + e]) ? { shape: i } : { antialiased: !0 })
                      : 0 < o
                      ? { antialiased: !0 }
                      : {};
                  }),
              ...
              function fe(t) {
                ...
                return (
                  (e.canvas = new H()),
                  (e.hitCanvas = new j({ pixelRatio: 1 })),
                  (e._waitingForDraw = !1),
                  e.on("visibleChange.konva", e._checkVisibility),
                  e._checkVisibility(),
                  e.on(
              ...
              (ve.prototype.nodeType = "FastLayer"), i(ve), o.mapMethods(ve);
              var me,
                _e =
                  (P(be, (me = ft)),
                  (be.prototype._validateAdd = function (t) {
                    ...
                    "Group" !== e &&
                      "Shape" !== e &&
                      A.throw("You may only add groups and shapes to groups.");
                  }),
                  be);
              function be() {
                return (null !== me && me.apply(this, arguments)) || this;
              }
              (_e.prototype.nodeType = "Group"), i(_e), o.mapMethods(_e);
              var xe =
                ...
                Se =
                  ((we.prototype.setLayers = function (t) {
                    var e = [],
                      e = t ? (0 < t.length ? t : [t]) : [];
                    return (this.layers = e), this;
                  }),
                  ...
                  (we._removeAnimation = function (t) {
                    for (
                      var e = t.id, i = this.animations, n = i.length, r = 0;
                      r < n;
                      r++
                    )
                      if (i[r].id === e) {
                  ...
                  (we._runFrames = function () {
                    ...
                    for (a in s) s.hasOwnProperty(a) && s[a].draw();
                  }),
              ...
              var Me =
                ((Ge.prototype._addAttr = function (t, e) {
                  var i,
                    n,
                    r,
                    o,
                  ...
                  if (
                    ...
                    if (
                      ...
                      "points" === t &&
                        ...
                        (e.length > i.length
                          ? ((s = i),
                            (i = A._prepareArrayForTween(i, e, c.closed())))
                          : ((a = e),
                  ...
                  for (e in c) {
                    if (
                      ...
                      if (
                        ...
                        for (a = 0; a < s; a++)
                          a % 2 == 0
                            ...
                            : o.push(
                                "rgba(" +
                                  Math.round(n[a].r + r[a].r * t) +
                                  "," +
                                  Math.round(n[a].g + r[a].g * t) +
                                  "," +
                                  Math.round(n[a].b + r[a].b * t) +
                                  "," +
                                  (n[a].a + r[a].a * t) +
                                  ")"
                              );
                      ...
                      o =
                        -1 !== ke.indexOf(e)
                          ? "rgba(" +
                            Math.round(n.r + r.r * t) +
                            "," +
                            Math.round(n.g + r.g * t) +
                            "," +
                            Math.round(n.b + r.b * t) +
                            "," +
                            (n.a + r.a * t) +
                            ")"
                          : n + r * t;
                ...
                (Ge.prototype.destroy = function () {
                  var t,
                    ...
                    i = this._id,
                    n = Ge.tweens[e];
                  for (t in (this.pause(), n)) delete Ge.tweens[e][t];
                  delete Ge.attrs[e][i];
                }),
                (Ge.attrs = {}),
                (Ge.tweens = {}),
                ...
                var e,
                  ...
                  s =
                    void 0 === t.duration
                      ...
                      ? 0.001
                      : t.duration;
                (this.node = n), (this._id = Pe++);
                var h =
                  n.getLayer() || (n instanceof G.Stage ? n.getLayers() : null);
                for (e in (h ||
                  A.error(
              ...
              var Re,
                Ee = {
                  ...
                  BackEaseOut: function (t, e, i, n) {
                    return (
                      i * ((t = t / n - 1) * t * (2.70158 * t + 1.70158) + 1) +
                      e
                    );
                  },
                  ...
                  BounceEaseInOut: function (t, e, i, n) {
                    return t < n / 2
                      ? 0.5 * Ee.BounceEaseIn(2 * t, 0, i, n) + e
                      : 0.5 * Ee.BounceEaseOut(2 * t - n, 0, i, n) +
                          0.5 * i +
                          e;
                  },
              ...
              var Oe,
                Fe =
                  ...
                  (Be.prototype._sceneFunc = function (t) {
                    ...
                    if (o) {
                      if (
                        (t.beginPath(), t.moveTo(r[0], r[1]), 0 !== a && 4 < o)
                      ) {
                        for (
                      ...
                      else for (n = 2; n < o; n += 2) t.lineTo(r[n], r[n + 1]);
                      s
                  ...
                  (Be.prototype._getTensionPoints = function () {
                    return this.closed()
                      ...
                      : A._expandPoints(this.points(), this.tension());
                  }),
                  (Be.prototype._getTensionPointsClosed = function () {
                    var t = this.points(),
                      e = t.length,
                      i = this.tension(),
                      n = A._getControlPoints(
                        t[e - 2],
                        t[e - 1],
                        t[0],
                        t[1],
                            ...
                            ? (function () {
                                ...
                                for (var n = Array(t), r = 0, e = 0; e < i; e++)
                                  for (
                                    ...
                                    n[r] = o[a];
                                return n;
                              })([t[0], t[1]], this._getTensionPoints(), [
                                t[t.length - 2],
                                t[t.length - 1],
                              ])
                            : this.points())[0],
                ...
                ze =
                  ...
                  (We.prototype._sceneFunc = function (t) {
                    ...
                    var o,
                      ...
                      s = r
                        ? ((o =
                            i[a - 2] - (n[n.length - 2] + n[n.length - 4]) / 2),
                          i[a - 1] - (n[n.length - 1] + n[n.length - 3]) / 2)
                        : ((o = i[a - 2] - i[a - 4]), i[a - 1] - i[a - 3]),
                      h = (Math.atan2(s, o) + e) % e,
                ...
                Ve =
                  ...
                  (Qe.prototype._sceneFunc = function (t) {
                    ...
                    a &&
                      ...
                      (n =
                        e && i
                          ? [a, this.cropX(), this.cropY(), e, i, 0, 0, r, o]
                          : [a, 0, 0, r, o])),
              ...
              (Ve.prototype.className = "Image"),
                ...
                w.addComponentsGetterSetter(Ve, "crop", [
                  "x",
                  "y",
                  "width",
                  "height",
                ...
                ni =
                  ...
                  (ri.prototype._sync = function () {
                    ...
                    if (s && h) {
                      ...
                      h.setAttrs({ x: -1 * r, y: -1 * o, width: t, height: e }),
                        s.setAttrs({ x: -1 * r, y: -1 * o });
                    }
                  }),
                  ri);
              function ri(t) {
                ...
                return (
                  e.on("add.konva", function (t) {
                    this._addListeners(t.child), this._sync();
                  }),
                  e
                );
              }
              (ni.prototype.className = "Label"), i(ni), o.mapMethods(ni);
              var oi,
                ai =
                  (P(si, (oi = he)),
              ...
              var hi,
                li =
                  ...
                  (ci.prototype.getSelfRect = function () {
                    ...
                    this.dataArray.forEach(function (t) {
                      if ("A" === t.command) {
                        var e = t.points[4],
                          ...
                          r = Math.PI / 180;
                        if (
                          (Math.abs(e - n) < r && (r = Math.abs(e - n)), i < 0)
                        )
                          for (var o = e - r; n < o; o -= r) {
                            var a = ci.getPointOnEllipticalArc(
                              t.points[0],
                              t.points[1],
                              t.points[2],
                              t.points[3],
                    ...
                    for (
                      var t, e, i = s[0], n = s[0], r = s[1], o = s[1], a = 0;
                      a < s.length / 2;
                      a++
                    )
                      (t = s[2 * a]),
                  ...
                  (ci.prototype.getPointAtLength = function (t) {
                    ...
                    switch (r.command) {
                      ...
                      case "C":
                        return ci.getPointOnCubicBezier(
                          t / r.pathLength,
                          r.start.x,
                          r.start.y,
                          o[0],
                      ...
                      case "Q":
                        return ci.getPointOnQuadraticBezier(
                          t / r.pathLength,
                          r.start.x,
                          r.start.y,
                          o[0],
                  ...
                  (ci.getPointOnCubicBezier = function (
                    t,
                    e,
                    i,
                    n,
                  ...
                  (ci.getPointOnQuadraticBezier = function (
                    t,
                    e,
                    i,
                    n,
                  ...
                  (ci.parsePathData = function (t) {
                    ...
                    for (
                      ...
                      var d = (p = o[n]).charAt(0),
                        p = p.slice(1);
                      for (s.length = 0; (r = c.exec(p)); ) s.push(r[0]);
                  ...
                  (ci.convertEndpointToCenterParameterization = function (
                    t,
                    e,
                    i,
                    n,
                  ...
                  (ui.prototype._sceneFunc = function (t) {
                    ...
                    t.beginPath(),
                      o
                        ? ((r = n = i = e = 0),
                          "number" == typeof o
                            ? (e = i = n = r = Math.min(o, a / 2, s / 2))
                            : ((e = Math.min(o[0], a / 2, s / 2)),
                ...
                gi =
                  ...
                  (vi.prototype._sceneFunc = function (t) {
                    var e,
                      ...
                      r = this.sides(),
                      o = this.radius();
                    for (t.beginPath(), t.moveTo(0, 0 - o), e = 1; e < r; e++)
              ...
              (_i.prototype.className = "Ring"),
                ...
                (_i.prototype._attrsAffectingSize = [
                  "innerRadius",
                  "outerRadius",
                ]),
                i(_i),
              ...
              (Pi.prototype.className = "Star"),
                ...
                (Pi.prototype._attrsAffectingSize = [
                  "innerRadius",
                  "outerRadius",
                ]),
                i(Pi),
              ...
              var Ii,
                Li =
                  ...
                  (Di.prototype._sceneFunc = function (t) {
                    ...
                    for (
                      t.setAttr("font", this._getContextFont()),
                        ...
                        "middle" === s
                          ? (h = (this.getHeight() - a * r - 2 * i) / 2)
                          : "bottom" === s &&
                            (h = this.getHeight() - a * r - 2 * i),
                        t.translate(i, h + i),
                        e = 0;
                      e < a;
                      e++
                  ...
                  (Di.prototype.getWidth = function () {
                    return this.attrs.width === Ai ||
                      void 0 === this.attrs.width
                      ? this.getTextWidth() + 2 * this.padding()
                      : this.attrs.width;
                  }),
                  (Di.prototype.getHeight = function () {
                    return this.attrs.height === Ai ||
                      void 0 === this.attrs.height
                      ? this.fontSize() *
                          this.textArr.length *
                          this.lineHeight() +
                          2 * this.padding()
                  ...
                  (Di.prototype._setTextData = function () {
                    var t = this.text().split("\n"),
                      ...
                      f = "char" !== p && u,
                      g = this.ellipsis() && !u;
                    (this.textArr = []), (Ei().font = this._getContextFont());
                    for (
                      var v = g ? this._getTextWidth("…") : 0,
                        y = 0,
                        m = t.length;
                      y < m;
                      ++y
                      ...
                      if (a && l < b)
                        for (; 0 < _.length; ) {
                          ...
                          if (
                            ...
                            break;
                          if (
                            0 < (_ = (_ = _.slice(w)).trimLeft()).length &&
                            (b = this._getTextWidth(_)) <= l
                          ) {
                            this._addTextLine(_),
                              (d += n),
                              (i = Math.max(i, b));
              ...
              (Li.prototype._fillFunc = function (t) {
                ...
                (Li.prototype._attrsAffectingSize = [
                  "text",
                  "fontSize",
                  "padding",
                  "wrap",
              ...
              var Bi,
                Ni =
                  ...
                  (zi.prototype._hitFunc = function (t) {
                    ...
                    var e,
                      i = this.glyphInfo;
                    1 <= i.length && ((e = i[0].p0), t.moveTo(e.x, e.y));
                    for (var n = 0; n < i.length; n++) {
                      var r = i[n].p1;
                      t.lineTo(r.x, r.y);
                    }
                  ...
                  (zi.prototype._setTextData = function () {
                    ...
                    var p = Math.max(
                      this.textWidth + ((this.attrs.text || "").length - 1) * c,
                      0
                    );
                    this.glyphInfo = [];
                    for (var u = 0, i = 0; i < l.dataArray.length; i++)
                      0 < l.dataArray[i].pathLength &&
                        (u += l.dataArray[i].pathLength);
                    var n = 0;
                    ...
                    for (
                      var f,
                        ...
                        v,
                        r = this.text().split(""),
                        y = this.text().split(" ").length - 1,
                        o = -1,
                        m = 0,
                        _ = function () {
                          m = 0;
                          for (
                            var t = l.dataArray, e = o + 1;
                            e < t.length;
                            e++
                          ) {
                            if (0 < t[e].pathLength) return t[(o = e)];
                            "M" === t[e].command &&
                              (f = { x: t[e].points[0], y: t[e].points[1] });
                          }
                          return {};
                        },
                        a = function (t) {
                          ...
                          for (
                            ...
                            for (var r = i; void 0 === v; )
                              (v = _()) &&
                                r + v.pathLength < e &&
                                ((r += v.pathLength), (v = void 0));
                            if (Object.keys(v).length === 0 || void 0 === f)
                              return;
                            var o = !1;
                            switch (v.command) {
                              case "L":
                              ...
                              case "A":
                                ...
                                0 === m
                                  ? (m = a + 1e-8)
                                  : i < e
                                  ? (m += ((Math.PI / 180) * s) / Math.abs(s))
                                  : (m -= ((Math.PI / 360) * s) / Math.abs(s)),
                                  ((s < 0 && m < h) || (0 <= s && h < m)) &&
                                    ((m = h), (o = !0)),
                                  (g = li.getPointOnEllipticalArc(
                                    v.points[0],
                                    v.points[1],
                                    v.points[2],
                                    v.points[3],
                              ...
                              case "Q":
                                0 === m
                                  ...
                                  : (m -= (i - e) / v.pathLength),
                                  1 < m && ((m = 1), (o = !0)),
                                  (g = li.getPointOnQuadraticBezier(
                                    m,
                                    v.start.x,
                                    v.start.y,
                                    v.points[0],
                            ...
                            void 0 !== g &&
                              (i = li.getLineLength(f.x, f.y, g.x, g.y)),
                              o && ((o = !1), (v = void 0));
                          }
                        },
                        s = n / (l._getTextSize("C").width + c) - 1,
                        h = 0;
                      h < s && (a("C"), void 0 !== f && void 0 !== g);
                      h++
                    )
                      f = g;
                    for (
                      var b = 0;
                      b < r.length && (a(r[b]), void 0 !== f && void 0 !== g);
                      b++
                    ) {
              ...
              function zi(t) {
                ...
                return (
                  (e.dummyCanvas = A.createCanvasElement()),
                  (e.dataArray = []),
              ...
              (Ni.prototype._fillFunc = Oi),
                ...
                (Ni.prototype._attrsAffectingSize = [
                  "text",
                  "fontSize",
                  "data",
                ]),
              ...
              function Ki(t, e, i) {
                var n =
                    i.x + (t.x - i.x) * Math.cos(e) - (t.y - i.y) * Math.sin(e),
                  r =
                    i.y + (t.x - i.x) * Math.sin(e) + (t.y - i.y) * Math.cos(e);
                return k(k({}, t), { rotation: t.rotation + e, x: n, y: r });
              }
              function Vi(t, e) {
                var i;
                return Ki(t, e, {
                  x:
                    (i = t).x +
                    (i.width / 2) * Math.cos(i.rotation) +
                    (i.height / 2) * Math.sin(-i.rotation),
                  y:
                    i.y +
                    (i.height / 2) * Math.cos(i.rotation) +
                    (i.width / 2) * Math.sin(i.rotation),
                });
              }
              var Qi,
                Ji =
                  ...
                  (Zi.prototype.__getNodeShape = function (t, e, i) {
                    ...
                    var n = t.getClientRect({
                      ...
                      h =
                        (G.getAngle(t.getAbsoluteRotation()) + 2 * Math.PI) %
                        (2 * Math.PI);
                    return Ki(
                      {
                      ...
                      r.on("mouseenter", function () {
                        var t = G.getAngle(n.rotation()),
                          e = (function (t, e) {
                            ...
                            return A._inRange(i, 337.5, 360) ||
                              A._inRange(i, 0, 22.5)
                              ? "ns-resize"
                              : A._inRange(i, 22.5, 67.5)
                              ? "nesw-resize"
                              : A._inRange(i, 67.5, 112.5)
                              ? "ew-resize"
                              : A._inRange(i, 112.5, 157.5)
                              ? "nwse-resize"
                              : A._inRange(i, 157.5, 202.5)
                              ? "ns-resize"
                              : A._inRange(i, 202.5, 247.5)
                              ? "nesw-resize"
                              : A._inRange(i, 247.5, 292.5)
                              ? "ew-resize"
                              : A._inRange(i, 292.5, 337.5)
                              ? "nwse-resize"
                              : (A.error(
                  ...
                  (Zi.prototype._handleMouseMove = function (t) {
                    ...
                    var a,
                      ...
                      T,
                      A,
                      M = e.getAbsolutePosition();
                    (o.x === M.x && o.y === M.y) ||
                      ("rotater" !== this._movingAnchorName
                        ? ((a = this.keepRatio() || t.shiftKey),
                          (p = this.centeredScaling() || t.altKey),
                          "top-left" === this._movingAnchorName
                            ? a &&
                              ((l = p
                              ...
                              (c =
                                this.findOne(".top-left").x() > l.x ? -1 : 1),
                              (d =
                                this.findOne(".top-left").y() > l.y ? -1 : 1),
                              (w = s * this.cos * c),
                              (C = s * this.sin * d),
                              this.findOne(".top-left").x(l.x - w),
                              this.findOne(".top-left").y(l.y - C))
                            : "top-center" === this._movingAnchorName
                            ? this.findOne(".top-left").y(e.y())
                            : "top-right" === this._movingAnchorName
                            ? (a &&
                                ((l = p
                                  ? {
                                      x: this.width() / 2,
                                ...
                                (c =
                                  this.findOne(".top-right").x() < l.x
                                    ? -1
                                    : 1),
                                (d =
                                  this.findOne(".top-right").y() > l.y
                                    ? -1
                                    : 1),
                                (w = s * this.cos * c),
                                (C = s * this.sin * d),
                            ...
                            : "middle-left" === this._movingAnchorName
                            ? this.findOne(".top-left").x(e.x())
                            : "middle-right" === this._movingAnchorName
                            ? this.findOne(".bottom-right").x(e.x())
                            : "bottom-left" === this._movingAnchorName
                            ? (a &&
                                ((l = p
                                  ? {
                                      x: this.width() / 2,
                            ...
                            : "bottom-center" === this._movingAnchorName
                            ? this.findOne(".bottom-right").y(e.y())
                            : "bottom-right" === this._movingAnchorName
                            ? a &&
                              ((l = p
                                ? { x: this.width() / 2, y: this.height() / 2 }
                                : {
                              ...
                              this.findOne(".bottom-right").y(l.y + C))
                            : console.error(
                                new Error(
                          ...
                          (p = this.centeredScaling() || t.altKey) &&
                            ...
                            u.move({ x: y, y: m })),
                          (w = (_ =
                            this.findOne(".top-left").getAbsolutePosition()).x),
                          (C = _.y),
                          (b =
                  ...
                  (Zi.prototype._fitNodesInto = function (t, o) {
                    var e,
                      ...
                      h = this,
                      l = this._getNodeRect();
                    A._inRange(t.width, 2 * -this.padding() - 1, 1) ||
                    A._inRange(t.height, 2 * -this.padding() - 1, 1)
                      ? this.update()
                      : ((e = new p()).rotate(G.getAngle(this.rotation())),
                        this._movingAnchorName &&
                        t.width < 0 &&
                        0 <= this._movingAnchorName.indexOf("left")
                          ? ((i = e.point({ x: 2 * -this.padding(), y: 0 })),
                            (t.x += i.x),
                            (t.y += i.y),
                            (t.width += 2 * this.padding()),
                            (this._movingAnchorName =
                              this._movingAnchorName.replace("left", "right")),
                            (this._anchorDragOffset.x -= i.x),
                            (this._anchorDragOffset.y -= i.y))
                          : this._movingAnchorName &&
                            t.width < 0 &&
                            0 <= this._movingAnchorName.indexOf("right") &&
                            ((i = e.point({ x: 2 * this.padding(), y: 0 })),
                            (this._movingAnchorName =
                              this._movingAnchorName.replace("right", "left")),
                            (this._anchorDragOffset.x -= i.x),
                            (this._anchorDragOffset.y -= i.y),
                            (t.width += 2 * this.padding())),
                        this._movingAnchorName &&
                        t.height < 0 &&
                        0 <= this._movingAnchorName.indexOf("top")
                          ? ((i = e.point({ x: 0, y: 2 * -this.padding() })),
                            (t.x += i.x),
                            (t.y += i.y),
                            (this._movingAnchorName =
                              this._movingAnchorName.replace("top", "bottom")),
                            (this._anchorDragOffset.x -= i.x),
                            (this._anchorDragOffset.y -= i.y),
                            (t.height += 2 * this.padding()))
                          : this._movingAnchorName &&
                            t.height < 0 &&
                            0 <= this._movingAnchorName.indexOf("bottom") &&
                            ((i = e.point({ x: 0, y: 2 * this.padding() })),
                            (this._movingAnchorName =
                              this._movingAnchorName.replace("bottom", "top")),
                            (this._anchorDragOffset.x -= i.x),
                            (this._anchorDragOffset.y -= i.y),
                            (t.height += 2 * this.padding())),
                        this.boundBoxFunc() &&
                          ((n = this.boundBoxFunc()(l, t))
                            ? (t = n)
                            : A.warn(
                        ...
                        this._nodes.forEach(function (t) {
                          ...
                          var n = new p();
                          n.multiply(e.copy().invert())
                            .multiply(s)
                            .multiply(e)
                            .multiply(i);
                          var r = n.decompose();
                          t.setAttrs(r),
                            h._fire("transform", { evt: o, target: t }),
                            t._fire("transform", { evt: o, target: t });
                        }),
                  ...
                  (Zi.prototype.stopTransform = function () {
                    ...
                    this._transforming &&
                      (this._removeEvents(),
                      (t = this.findOne("." + this._movingAnchorName)) &&
                        t.stopDrag());
                  }),
              ...
              (Ji.prototype.className = "Transformer"),
                ...
                w.addGetterSetter(Ji, "enabledAnchors", qi, function (t) {
                  return (
                    t instanceof Array ||
                      A.warn("enabledAnchors value should be an array"),
                    t instanceof Array &&
                      t.forEach(function (t) {
                        -1 === qi.indexOf(t) &&
                          A.warn(
              ...
              var rn = [
                  ...
                  388, 335, 292, 512, 454, 405, 364, 328, 298, 271, 496, 456,
                  420, 388, 360, 335, 312, 292, 273, 512, 482, 454, 428, 405,
                  383, 364, 345, 328, 312, 298, 284, 271, 259, 496, 475, 456,
                  437, 420, 404, 388, 374, 360, 347, 335, 323, 312, 302, 292,
                  282, 273, 265, 512, 497, 482, 468, 454, 441, 428, 417, 405,
                  394, 383, 373, 364, 354, 345, 337, 328, 320, 312, 305, 298,
                  291, 284, 278, 271, 265, 259, 507, 496, 485, 475, 465, 456,
                  446, 437, 428, 420, 412, 404, 396, 388, 381, 374, 367, 360,
                  354, 347, 341, 335, 329, 323, 318, 312, 307, 302, 297, 292,
                  287, 282, 278, 273, 269, 265, 261, 512, 505, 497, 489, 482,
                  475, 468, 461, 454, 447, 441, 435, 428, 422, 417, 411, 405,
                  399, 394, 389, 383, 378, 373, 368, 364, 359, 354, 350, 345,
                  341, 337, 332, 328, 324, 320, 316, 312, 309, 305, 301, 298,
                  294, 291, 287, 284, 281, 278, 274, 271, 268, 265, 262, 259,
                  257, 507, 501, 496, 491, 485, 480, 475, 470, 465, 460, 456,
                  451, 446, 442, 437, 433, 428, 424, 420, 416, 412, 408, 404,
                  400, 396, 392, 388, 385, 381, 377, 374, 370, 367, 363, 360,
                  357, 354, 350, 347, 344, 341, 338, 335, 332, 329, 326, 323,
                  320, 318, 315, 312, 310, 307, 304, 302, 299, 297, 294, 292,
                  289, 287, 285, 282, 280, 278, 275, 273, 271, 269, 267, 265,
                  263, 261, 259,
                ],
                on = [
              ...
              function sn(t, e, i) {
                var n = 4 * (i * t.width + e),
                  r = [];
                return (
                  r.push(t.data[n++], t.data[n++], t.data[n++], t.data[n++]), r
                );
              }
              function hn(t, e) {
                return Math.sqrt(
              ...
              w.addGetterSetter(ct, "noise", 0.2, y(), w.afterSetFilter);
              w.addGetterSetter(ct, "pixelSize", 8, y(), w.afterSetFilter);
              w.addGetterSetter(ct, "levels", 0.5, y(), w.afterSetFilter);
              ...
              return (
                w.addGetterSetter(ct, "threshold", 0.5, y(), w.afterSetFilter),
                Ie.Util._assign(Ie, {
                  Arc: Le,
                  Arrow: ze,
                  Circle: Ye,
                  ...
                  Filters: {
                      ...
                      0 < e &&
                        (function (t, e) {
                          for (
                            ...
                            (D = D.next = new nn()), z === R && (L = D);
                          for (D.next = I, s = a = 0, n = 0; n < T; n++) {
                            for (
                              v = y = m = _ = h = l = c = d = 0,
                                p = R * (b = P[a]),
                                u = R * (x = P[a + 1]),
                    ...
                    Grayscale: function (t) {
                      for (
                        var e, i = t.data, n = i.length, r = 0;
                        r < n;
                        r += 4
                      )
                        (e = 0.34 * i[r] + 0.5 * i[r + 1] + 0.16 * i[r + 2]),
                          (i[r] = e),
                          (i[r + 1] = e),
                          (i[r + 2] = e);
                    },
                    HSL: function (t) {
                      for (
                        var e,
                          ...
                          c = s * Math.cos((h * Math.PI) / 180),
                          d = s * Math.sin((h * Math.PI) / 180),
                          p = 0.299 + 0.701 * c + 0.167 * d,
                          u = 0.587 - 0.587 * c + 0.33 * d,
                          f = 0.114 - 0.114 * c - 0.497 * d,
                          g = 0.299 - 0.299 * c - 0.328 * d,
                          v = 0.587 + 0.413 * c + 0.035 * d,
                          y = 0.114 - 0.114 * c + 0.293 * d,
                          m = 0.299 - 0.3 * c + 1.25 * d,
                          _ = 0.587 - 0.586 * c - 1.05 * d,
                          b = 0.114 + 0.886 * c - 0.2 * d,
                          x = 0;
                        x < a;
                        x += 4
                      )
                    ...
                    HSV: function (t) {
                      for (
                        var e,
                          ...
                          c = s * h * Math.cos((l * Math.PI) / 180),
                          d = s * h * Math.sin((l * Math.PI) / 180),
                          p = 0.299 * s + 0.701 * c + 0.167 * d,
                          u = 0.587 * s - 0.587 * c + 0.33 * d,
                          f = 0.114 * s - 0.114 * c - 0.497 * d,
                          g = 0.299 * s - 0.299 * c - 0.328 * d,
                          v = 0.587 * s + 0.413 * c + 0.035 * d,
                          y = 0.114 * s - 0.114 * c + 0.293 * d,
                          m = 0.299 * s - 0.3 * c + 1.25 * d,
                          _ = 0.587 * s - 0.586 * c - 1.05 * d,
                          b = 0.114 * s + 0.886 * c - 0.2 * d,
                          x = 0;
                        x < a;
                        x += 4
                      )
                      ...
                      if (!(p < 1)) {
                        ...
                        !(function (t, e, i) {
                          for (
                            ...
                            for (
                              o = Math.sin(C * w), a = Math.cos(C * w), r = 0;
                              r < x;
                              r += 1
                            )
                              (m = Math.floor(d + ((y * r) / x) * a)),
                                ...
                                (h[n + 2] = g),
                                (h[n + 3] = v);
                        })(t, v, { polarCenterX: c / 2, polarCenterY: d / 2 });
                            ...
                            (e = (function (t, e, i) {
                              for (
                                var n = [
                                  ...
                                  r = Math.round(Math.sqrt(n.length)),
                                  o = Math.floor(r / 2),
                                  a = [],
                                  s = 0;
                                s < i;
                    ...
                    Pixelate: function (t) {
                      var e,
                        ...
                        _ = Math.ceil(y / g),
                        b = t.data;
                      if (g <= 0) A.error("pixelSize value can not be <= 0");
                      else
                        for (p = 0; p < m; p += 1)
                          for (u = 0; u < _; u += 1) {
                            for (
                    ...
                    Sepia: function (t) {
                      for (
                        var e, i, n, r = t.data, o = r.length, a = 0;
                        a < o;
                        a += 4
                      )
                        (e = r[a + 0]),
                          ...
                          (r[a + 0] = Math.min(
                            255,
                            0.393 * e + 0.769 * i + 0.189 * n
                          )),
                          (r[a + 1] = Math.min(
                            255,
                            0.349 * e + 0.686 * i + 0.168 * n
                          )),
                          (r[a + 2] = Math.min(
                            255,
                            0.272 * e + 0.534 * i + 0.131 * n
                          ));
                    },
                    Solarize: function (t) {
                      var e = t.data,
          ...
          // styles
          const responsiveDivider = 555;
          if (
            document.querySelector("#cf-theme-styles") == null &&
            ...
            style.innerHTML = `
                        ...
                        :root {
                            --cf-background-default: #fefcfd;
                            --cf-background-success: #009b72;
                            --cf-background-error: #f24c00;
                            --cf-text-default: #04030f;
                            --cf-text-additional: #eee;
                            --cf-text-disabled: #53687e;
                        }
                        ...
                        .cf_image-wrapper:hover {
                         cursor: pointer;
                          background-color: darkgray !important; /* Darker blue color on hover */
                        }
                        ...
                        .cf_tools-container {
                            ...
                            background-color: rgba(255, 255, 255, 0.95); /* 95% transparent */
                        ...
                        .cf_tools-wrapper > div:first-child {
                            display: flex;
                            flex-direction: row;
                            gap: 10px;
                            align-items: center;
                        ...
                        .cf_tools-wrapper > div:last-child {
                            display: flex;
                            flex-direction: row;
                            gap: 10px;
                            margin-top: 10px;
                        ...
                        @media (max-width: ${responsiveDivider}px) {
                            .cf_tools-wrapper {
                                flex-direction: row;
                                gap: 10px;
                                align-items: center;
                        ...
                        .cf_button.cf_context-menu__button {
                            border-radius: 40px;
                        ...
                        .cf_button.cf_state-redo,
                        .cf_button.cf_state-undo {
                            color: transparent;
                        ...
                        .cf_drawer input[type=number] {
                            color: var(--cf-text-default);
                            width: 50px;
                        }

                        .cf_drawer input[type=checkbox] + label {
                            display: block;
                            cursor: pointer;
                            width: 30px;
                            height: 30px;
                            border-left: 4px solid var(--cf-background-error);
                            background-image: url(assets/img/draw.png);
                            background-size: 20px;
                            background-position: center;
                            background-repeat: no-repeat;
                        }

                        .cf_drawer input[type=checkbox]:checked + label {
                            border: none;
                            border-right: 4px solid var(--cf-background-success);
                        ...
                        .cf_drawer input[type=color] {
                            ...
                            padding: 0;
                            border-radius: 50%;
                            border: 1px solid var(--cf-text-additional);
                        }

                        .cf_drawer input[type=color]::-webkit-color-swatch-wrapper {
                            padding: 0;
                        }

                        .cf_drawer input[type=color]::-webkit-color-swatch {
                            border: none;
                        }

                        .cf_drawer input[type=color]::-moz-focus-inner {
                            border: none;
                            padding: 0;
                        }

                        .cf_drawer input[type=color]::-moz-color-swatch {
                            border: none;
                            height: 30px;
                        }
                        ...
                        @media (min-width: ${responsiveDivider + 1}px) {
                            .cl-open-popup {
                                display: none;
                            }
                        }
          ...
          let uniq =
            document.querySelectorAll(".cf_canvas__wrapper").length + 1;
          let wrapperId = `cf_root${uniq}`;
          let canvasId = `cf_canvas${uniq}`;
          let stageId = `cf_stage${uniq}`;

          // responsive blocks
          const openPopupEl = document.createElement("label");
          openPopupEl.setAttribute("for", "inputResponsive");
          openPopupEl.classList.add("cl-open-popup", "cf_button");
          openPopupEl.textContent = "Upload Design";
          document.body.appendChild(openPopupEl);

          const inputResponsiveEl = document.createElement("input");
          inputResponsiveEl.type = "checkbox";
          inputResponsiveEl.classList.add("cl-input-responsive");
          inputResponsiveEl.id = "inputResponsive";
          parent.appendChild(inputResponsiveEl);

          const getResponseInputCheck = () =>
            window.innerWidth > responsiveDivider ? true : false;
          inputResponsiveEl.checked = getResponseInputCheck();

          window.addEventListener("resize", () => {
            inputResponsiveEl.checked = getResponseInputCheck();
          });
          // responsive blocks end
          ...
          let container_width =
            containerWidth == undefined ? 200 : containerWidth;
          let container_height =
            containerHeight == undefined ? 200 : containerHeight;
          ...
          if (Object.getOwnPropertyNames(extensions).length > 0) {
            ...
            let toolsWrapper =
              toolsContainer.querySelector(".cf_tools-wrapper");

            //tools visual
            toolsContainer
              .querySelector(".cf_tools-toggle")
            ...
            function stopDrawing() {
              ...
              wrapper
                .querySelectorAll(".cf_drawing-enable")
                .forEach(function (item) {
                  item.checked = false;
                });
            ...
            if (extensions.add_draw_mode) {
              ...
              stage.on("mousedown touchstart", function (e) {
                ...
                if (canDraw) {
                  ...
                  stage.cfDrawingConfig.lastLine = new Konva.Line({
                    ...
                    globalCompositeOperation:
                      stage.cfDrawingConfig.cfMode === "brush"
                        ? "source-over"
                        : "destination-out",
                    points: [pos.x, pos.y],
                    name: "line",
              ...
              stage.on("mousemove touchmove", function () {
                if (stage.cfDrawingConfig.cfIsPaint) {
                  ...
                  var newPoints = stage.cfDrawingConfig.lastLine
                    .points()
                    .concat([pos.x, pos.y]);
            ...
            if (extensions.add_draw_mode && extensions.add_drawing_tools_mode) {
              ...
              drawingToolsNode
                ...
                .forEach(function (item) {
                  item.addEventListener("change", function () {
                    Konva.ids[
                      item.dataset.stage
                    ].cfDrawingConfig.cfDrawingModeEnabled = item.checked;
                  });
                });
              ...
              //brush color
              drawingToolsNode
                .querySelectorAll(".cf_drawing-color")
                .forEach(function (item) {
                  item.addEventListener("input", function () {
                    Konva.ids[item.dataset.stage].cfDrawingConfig.cfBrushColor =
                      item.value;
                  });
                });
              ...
              //brush size
              drawingToolsNode
                .querySelectorAll(".cf_drawing-size")
                .forEach(function (item) {
                  item.addEventListener("input", function () {
                    Konva.ids[
                      item.dataset.stage
                    ].cfDrawingConfig.cfstrokeWidth = item.value;
                  });
                });
            }
            ...
            if (extensions.add_text_mode) {
              ...
              textToolsNode
                ...
                .forEach(function (item) {
                  item.addEventListener("click", function () {
                    ...
                    let fontFamily =
                      textToolsNode.querySelectorAll(".cf_text-font")[0].value;
                    ...
                    textNode.on(
                      "transformstart dragmove transform transformend",
                      function () {
                        updateTexture(stage);
                      }
                    );
              ...
              textToolsNode
                ...
                .forEach(function (item) {
                  item.addEventListener("change", function () {
                    ...
                    if (activeText) {
                      let fontFamily =
                        textToolsNode.querySelectorAll(".cf_text-font")[0]
                          .value;
              ...
              //brush color
              textToolsNode
                .querySelectorAll(".cf_text-color")
                .forEach(function (item) {
                  item.addEventListener("input", function () {
                    Konva.ids[item.dataset.stage].cfTextConfig.fontColor =
                      item.value;
            ...
            if (extensions.add_sticker_mode) {
              ...
              // Event handlers
              const stickerButton =
                stickerBlock.querySelector(".cf_sticker-button");
              const closeButton = stickerModal.querySelector(
                ".cf_sticker-modal-close"
              );
              ...
              function loadStickerGallery() {
                gallery.innerHTML = `
                  ...
                  ">
                    ...
                    "></div>
                    <div style="color: #666; font-size: 16px;">Loading Load stickers...</div>
                  </div>
                `;
                ...
                setTimeout(() => {
                  ...
                  stickerList.forEach((sticker) => {
                    ...
                    //Style differences for SVGs and images
                    if (sticker.type === "svg") {
                      img.style.cssText = `
                    ...
                    //Add a badge to distinguish sticker types
                    const badge = document.createElement("div");
                    badge.style.cssText = `
                      position: absolute; top: 2px; right: 2px; 
                      background: ${
                        sticker.type === "svg" ? "#4caf50" : "#ff9800"
                      }; 
                    ...
                    stickerItem.addEventListener("mouseenter", function () {
                      ...
                      this.style.boxShadow =
                        "0 4px 12px rgba(77, 151, 231, 0.3)";
                    });
              ...
              function addStickerToCanvas(
                ...
                imageObj.onload = function () {
                  ...
                  if (stickerType === "svg") {
                    //SVGs usually have smaller and cleaner sizes
                    defaultWidth = 80;
                    defaultHeight = 80;
                  } else {
                    //Images usually need a size that fits the aspect ratio
                    const aspectRatio =
                  ...
                  console.log(
                    `✅ ${stickerType.toUpperCase()} sticker added successfully:`,
                    stickerTitle
                  );
                };
            ...
            if (extensions.add_transform_mode) {
              ...
              stage.on("contextmenu", function (e) {
                ...
                if (menuBounds.bottom > window.innerHeight) {
                  stage.cfTransforming.menuNode.style.top = `${
                    e.evt.layerY - menuBounds.height
                  }px`;
                }
                if (menuBounds.right > window.innerWidth) {
                  stage.cfTransforming.menuNode.style.left = `${
                    e.evt.layerX - menuBounds.width
                  }px`;
                }
              });
            }
                ...
                newImg.onload = function () {
                  try {
                    ...
                    finalImg.onload = function () {
                      ...
                      console.log(
                        "🎉 Image updated on canvas with base64 data URL successfully!"
                      );
                      console.log(
                        "📝 Base64 length:",
            ...
            function checkSharpnessOpenCV(imgElement) {
              return new Promise((resolve) => {
                ...
                try {
                  ...
                  console.log("Sharpness value:", sharpness);
...
`;
              ...
              border-radius: 10px; z-index: 9999; font-size: 16px; text-align: center;
          `;
                    ...
                    try {
                      ...
                      console.log(
                        `Final sharpness: ${sharpness.toFixed(
                          2
                        )} (Threshold: ${threshold})`
                      );
                      ...
                      if (isBlurry) {
                        ...
                        const proceed = confirm(
                          `⚠️ Ảnh có Appearance Be Blur (degree nét = ${sharpness.toFixed(
                            2
                        ...
                        console.log("✅ The image has good sharpness.");
                      }
            ...
            if (true) {
              ...
              function cfApplyState(state) {
                //visual appearance
                undoRedo
                  .querySelector(".cf_state-redo")
                  .removeAttribute("disabled");
                undoRedo
                  .querySelector(".cf_state-undo")
                  .removeAttribute("disabled");
              ...
              window.appHistoryStep = 0; //0 - fill; -1 - images
    ...
    function replaceTexture(matName, texName, texUrlOrElem, doCb) {
      const textures = PzLib.getMaterialEditableTextures(matName, true).filter(
        function (elem) {
      ...
      function processImageUrl(url) {
        ...
        textures.forEach(function (elem) {
          if (elem.isCompressedTexture) isCompOld = true;
          if (elem.isVideoTexture) isVideoOld = true;
        });
    ...
    function create_canvas_drawer(loadSavedLayout) {
      var VARS = Object.defineProperties(
        {},
        {
          loadSavedLayout: {
      ...
      if (featureAvailable("MOBILE")) {
        setHTMLElemAttribute("innerHTML", "", "myClass", false);
        myDrawer2 = cf_drawInit(
        ...
        addHTMLElement(
          ...
          "closecanvas",
          "AFTER",
          ["QUERYSELECTOR", "#myClass .cf_state-reset"],
          false
        );
        setHTMLElemAttribute("innerHTML", "X", "closecanvas", false);
        setHTMLElemAttribute("className", "cf_button", "closecanvas", false);
        ...
        if (loadSavedLayout) {
          ...
          Function(
            ...
            "const stageId = VARS.myDrawer2.dataset.stage;" +
              ...
              "\n" +
              "const layers = VARS.currentSceneState.savedLayers;" +
              "\n" +
              "for (let i = 1; i < layers.length; i++) {" +
              "\n" +
              "  layer.add(layers[i].clone());" +
              "\n" +
              "}" +
              "\n" +
              "layer.draw();" +
              "\n" +
              "document.querySelector('#myClass .cf_tools-toggle').click();"
          )(appInstance, v3d, PL, VARS, PROC);
        }
        replaceTexture(
          "Base",
          "yourdesignhere.png.001",
          myDrawer2,
          function () {}
        );
      } else {
        ...
        addHTMLElement(
          ...
          "closecanvas",
          "TO",
          ["QUERYSELECTOR", "#myClass .cf_drawing"],
          false
        );
        setHTMLElemAttribute("innerHTML", "X", "closecanvas", false);
        setHTMLElemAttribute("className", "cf_button", "closecanvas", false);
    ...
    async function loadFile(url, onceReadyCb, onErrorCb, caching) {
      ...
      try {
        ...
        const options = {};
        if (!caching) options.headers = { "Cache-Control": "no-cache" };
        ...
        else _pGlob.loadedFile = await response.text();
    ...
    // Describe this function...
    function import_layout_from_file() {
      openFile(function () {
        loadFile(
          openedFile("DATA"),
          function () {
    ...
    function restore_saved_canvas_layers() {
      Function(
        ...
        "const state = VARS.currentSceneState;" +
          ...
          "" +
          "\n" +
          "const layers = state.savedLayers;" +
          "\n" +
          "if (layers.length) {" +
          "\n" +
          "  for (let i = 0; i < layers.length; i++) {" +
          "\n" +
          "    layers[i] = JSON.parse(layers[i]);" +
          "\n" +
          "  }" +
          "\n" +
          "}" +
          ...
          "" +
          "\n" +
          "const readyImages = state.readyImages;" +
          "\n" +
          "const savedLayers = VARS.currentSceneState.savedLayers;" +
          "\n" +
          "const stage = Konva.ids[VARS.myDrawer2.dataset.stage];" +
          "\n" +
          ...
          "" +
          "\n" +
          "function createImageLayer(img, x, y, rot, scX, scY, w, h, name) {" +
          "\n" +
          "  const imageLayer = new Konva.Image({" +
          "\n" +
          "    x: x, y: y, rotation: rot, scaleX: scX, scaleY: scY," +
          "\n" +
          "    image: img, width: w, height: h, name: name, draggable: true" +
          "\n" +
          "  });" +
          "\n" +
          "  " +
          ...
          "" +
          "\n" +
          "function createTextLayer(text, x, y, rot, scX, s, f, w, name, col) {" +
          "\n" +
          "  const textNode = new Konva.Text({" +
          "\n" +
          "    text: text, x: x, y: y, rotation: rot, scaleX: scX, fontSize: s," +
          "\n" +
          "    fontFamily: f, draggable: true, width: w, name: name, fill: col" +
          "\n" +
          "  });" +
          "\n" +
          ...
          "" +
          "\n" +
          "function createStrokeLayer(stroke, width, points, name) {" +
          "\n" +
          "  const strokeNode = new Konva.Line({" +
          "\n" +
          "    stroke: stroke, strokeWidth: width, points: points, name: name," +
          "\n" +
          "    globalCompositeOperation: 'source-over', listening: false" +
          "\n" +
          "  });" +
          "\n" +
          "  return strokeNode;" +
    ...
    function getMaterialColor(matName, colName, coord) {
      ...
      if (mats.length) {
        ...
        switch (coord) {
          ...
          case "CSS_HEX":
          case "CSS_RGB":
            if (coord == "CSS_HEX") return "#" + color.getHexString();
            else return color.getStyle();
            break;
        }
      }
    }
    ...
    function getMaterialValue(matName, valName) {
      ...
      if (mats.length) {
        ...
        } else return mat[valName];
      }
    }

    // Describe this function...
    function export_layout_to_file() {
      ...
      Function(
        ...
        "const state = VARS.currentSceneState;" +
          ...
          "  layer.draw();" +
          "\n" +
          "  window.updateTexture(Konva.ids[stageId]);" +
          "\n" +
          "" +
          "\n" +
          ...
          "\n" +
          "link.download = state.sceneName + '_layout.sav';" +
          "\n" +
        ...
        function () {
          ...
          try {
            ...
            console.log(
              "📄 Loaded data:",
              typeof loadedData,
              loadedData ? "Data exists" : "No data"
            );
            ...
            Function(
              ...
              "PROC",
              "showUrlLoadingOverlay",
              "updateUrlLoadingProgress",
              "showUrlLoadingSuccess",
              "showUrlLoadingError",
              ...
              if (array.length) {
                ...
                PROC.create_canvas_drawer(true);
                ShowUrlLoadingSuccess('Loadedoaded successfully', 'Design has been applied');
              ...
              function checkLoadedImages() {
                ...
                if (ready) {
                  ...
                  PROC.create_canvas_drawer(true);
                  showUrlLoadingSuccess('Uploaded successfully', 'Design has been applied');
      ...
      Function(
        ...
        .then(async res => {
          if (!res.ok) {
            ...
            throw new Error(\`Upload thất bại: \${res.status} \${res.statusText} - \${errorText}\`);
          }
...
//Use the available showShareModal functiondy
if (typeof showShareModal === 'function') {
  ...
  setTimeout(() => {
    if (typeof showShareModal === 'function') {
      ...
      //Final fallback with alert      alert('🎉 Design Plan đã possible Save thành công!\\n\\nLink chia Share:\\n' + shareableLink);
    }
  }, 500);
}
