...
async function checkInappropriateContent(base64ImageData) {
  try {
    //Call server API endpoint instead of calling OpenAI directly
    ...
    if (!response.ok) {
      ...
      //Return "toan" to not block users when the API has an error
      return {
    ...
    console.error('Error when checking content:', error);
    //Return "toan" to not block users if there is an error
    return {
      isInappropriate: false,
...
document.addEventListener('DOMContentLoaded', function () {
 ...
 function showShareModal(shareableLink) {
  ...
  modalBody.innerHTML = `
    <p><strong>Share link of your:n:</strong></p>
    ...
    <div class="share-buttons">
      ...
      <a href="https://www.instagram.com/" 
         ...
         onclick="copyShareLink('${shareableLink}'); alert('Link has been copied! Please paste into your Instagram Story or Post.');">
        📸 Instagram
      </a>
      <a href="https://zalo.me/pc" 
         target="_blank" class="share-button zalo"
         onclick="copyShareLink('${shareableLink}'); alert('Link has been copied! Please paste into Zalo to share.');">
        💬 Zalo
      </a>
    </div>
    
    <div class="share-modal-note">💡 Share this link so others can view your 3D design! </div>
  `;
