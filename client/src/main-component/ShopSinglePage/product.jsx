        ...
        <div className="product-details-content">
                ...
                {product.color.map((color, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      {(() => {
                        const lightColors = ['White', 'white', 'vàng', 'yellow', 'Light Gold', 'light yellow', 'vàng sáng', 'cream', 'beige'];
          ...
          <div className="cart-wrp">
            <div className="shop-button d-flex align-items-center">
              ...
              >
                <BsCartFill className="me-2" />{context.addingInCart? "Adding.": "Add to cart"}             <Link to="#" className="star-icon">
