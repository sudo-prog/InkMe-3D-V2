                ...
                <div className="row g-4 align-items-center">
                    <div className="col-lg-6">
                        <div className="hero-content">
                            ...
                            <p className="wow fadeInUp" data-wow-delay=".5s">We provide high-quality printing services.<br />With an experienced staff and modern equipment, we ensure products meet the highest standards.</p>
                            <ul className="list wow fadeInUp" data-wow-delay=".7s">
                                <li>
                                    <i className="fa-sharp fa-solid fa-check"></i>High quality</li>
                                <li>
                                    <i className="fa-sharp fa-solid fa-check"></i>Reasonable prices</li>
                            </ul>
