    ...
    html: `
          <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; background-color: #f9f9f9; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1);">
            ...
            <div style="background-color: #ffffff; padding: 20px; border-radius: 8px;">
              ...
              <p style="color: #333; font-size: 16px; text-align: center;">This is a confirmation email to change your password. To complete the process, please click the button below to go to the page to change the new password for your account.       </p>
              <div style="text-align: center; margin: 30px 0;">
            ...
            <div style="text-align: center; padding-top: 20px; color: #999; font-size: 12px;">
              <p>&copy; 2025 InkMe. All rights reserved.tect Save.</p>
            </div>
          </div>
        `,
  };
