...
//Only admins are allowed to upload product images
...
router.get(`/:id`, async (req, res) => {
    ...
    try {
        ...
        if (!product) {
            return res.status(500).json({ message: "Product ID not found" });  //Stop processing here
        }
...
//Only admins are allowed to delete products
...
//Only admins are allowed to update products
